...
var mobx_esm = /*#__PURE__*/Object.freeze({
    __proto__: null,
    $mobx: $mobx,
...
class Store {
    constructor(params) {
        ...
        Object.defineProperty(this, "dataOwner", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: ''
    ...
    saveToService() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!service || !dataKey || !dataOwner || !data)
                return;
            this.loading = true;
            yield service
                .save({
